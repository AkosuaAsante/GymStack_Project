...
<body>
  <div class="login-container">
    ...
    <form action="../action/register_user_action.php" class="form-background" method="POST"
      onsubmit="validateForm(event)" id="register-form" name="register-form">

      <h2 id="welcome-back">Register Here</h2>
      <p id="no-account">Already have an account? <a id="register" href="loginpage.php">Login</a></p>
